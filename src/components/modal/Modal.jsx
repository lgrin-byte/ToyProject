        ...
        <Back>
            <WrapModal ref={modalRef} type={type}>
                ...
                <TitleBox>
                    ...
                    />
                    <PlayBox>
                        <RedSpan>전주 10초</RedSpan>를 듣고{" "}
                        <RedSpan>제한시간 35초</RedSpan> 안에 <br />
                        <RedSpan>가수, 제목</RedSpan>을 입력해주세요.
                    </PlayBox>
                    ...
                    <PlayBox>
                        <UlModal>
                            ...
                            <LiModal>
                                <p>맞춤법이 다를시 오답처리됩니다.</p>
                            </LiModal>
                            <LiModal>
                                <p>
                                    ‘영어로 적어주세요'문구가 있는 칸은{" "}
                                    <RedSpan>영문,숫자로만 기입</RedSpan>
                                    해주세요.
                                    <br />
                                    <RedSpan>
                                        (한글 작성시 오답처리됩니다.)
